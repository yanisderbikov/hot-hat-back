...
/** Подтверждение начала съёмки. */
@Schema(description = "Начало съёмки принято")
public record RecorderStartSignalResponseDTO(
        ...
        @Schema(description = "Фаза комнаты в момент сигнала", example = "turnIntro",
